    ...
    <Accordion title="Core Ideas (6–12)" required defaultOpen>
      ...
      {items.map((ci, i) => (
        <div key={i} className="mb-4 bg-white/[0.04] rounded-2xl p-3">
          ...
          <label htmlFor={`${uid}-${i}-title`} className="text-ink-faint text-xs mb-1 block">Title *</label>
          ...
          <label htmlFor={`${uid}-${i}-body`} className="text-ink-faint text-xs mb-1 block">Body *</label>
          ...
          <label htmlFor={`${uid}-${i}-in-practice`} className="text-ink-faint text-xs mb-1 block">In practice (optional)</label>
          ...
          <label htmlFor={`${uid}-${i}-quote`} className="text-ink-faint text-xs mb-1 block">Pull quote (optional)</label>
