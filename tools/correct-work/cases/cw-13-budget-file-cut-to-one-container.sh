...
#     reached the floor.
#
# The set-equality assertion between the file keys and the step 23-name METRICS list runs BEFORE
# the floor and refuses in both directions, so any file reaching the floor already had exactly 23
...
# named as what it actually is: the 23-name METRICS literal, compared against the file both ways.
#
